...
(function () {
  ...
  el.resetBtn.addEventListener('click', () => {
    ...
    ['gre_verbal_known', 'gre_quant_known', 'gre_verbal_best', 'gre_quant_best', 'gre_verbal_best_history', 'gre_quant_best_history', 'gre_mock_history', 'gre_xp', 'gre_streak', 'gre_match_best', 'gre_speed_best'].forEach((k) => {
